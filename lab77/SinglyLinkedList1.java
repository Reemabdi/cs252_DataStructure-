...
public class SinglyLinkedList1<E> {
    ...
    private Node1<E> curr;   // Acess to current element
    private int size;
...
// update methods
    public void addFirst(E e) { // adds element e to the front of the list
        head = new Node1<>(e, head); // create and link a new node
        if (size == 0) {
    ...
    public void addLast(E e) { // adds element e to the end of the list
        Node1<E> newest = new Node1<>(e, null); // node will eventually be the tail
        if (isEmpty()) {
...
System.out.println("Cannot add ");
    ...
    Node1 curr = head;
       ...
       return;
        ...
        Node1 n=new Node1(d,curr.getNext());
             curr.setNext( n);
...
Node1 p1=temp1.getNext();
Node1 p2=temp2.getNext();
...
void MergeSortedList(SinglyLinkedList1 A,SinglyLinkedList1 B)   
 {
 Node1 curA=A.head;
 Node1 curB=B.head;
...
//   }
 //====================================
   ...
   SinglyLinkedList1 lst=new SinglyLinkedList1();
    ...
    //=========================================
     public SinglyLinkedList1 MaxinPostion(SinglyLinkedList1 list1,SinglyLinkedList1 list2)
     {if(list1.head==null||list2.head==null)
         return null;
     //===========================================
     SinglyLinkedList1 temp=new SinglyLinkedList1();
     Node1 cur1=list1.head;
     Node1 cur2=list2.head;
     int number=0;
     //============================================
     ...
     if(temp.head==null)
     { temp.head=temp.tail=new Node1(number,null);}
     else
     {
     temp.tail .setNext(new Node1(number,null));
    ...
    //==================================================
     ...
     //=============================================
     public SinglyLinkedList1 evenelements(int x){
     if(x<=0||x>size)
     return null;
     SinglyLinkedList1<Integer> temp=new SinglyLinkedList1();
     Node1 cur=head;
      
     while((Integer)head.getElement()%2==0)
     {
      if(temp.head==null)   
                 temp.head=temp.tail=new Node1(head.getElement(),null);
              else
              {  temp.tail.setNext(new Node1(head.getElement(),null));
              temp.tail=temp.tail.getNext();}
    ...
    for(int i=1;i<x;i++)
     {
             ...
             {
              if(temp.head==null)   
                 temp.head=temp.tail=new Node1(cur.getNext().getElement(),null);
              else
              {  temp.tail.setNext(new Node1(cur.getNext().getElement(),null));
              temp.tail=temp.tail.getNext();}
...
//=======================================================
  ...
  public void splitOddEven( SinglyLinkedList1 oddlist, SinglyLinkedList1 evenlist   ){
  if(head==null)
  return;
  //==============================
  Node1 cur=head;
  ...
  if((int)cur.getElement()%2==1)
  {
    ...
    {oddlist.head=new Node1(cur.getElement(),null);
    oddlist.tail=oddlist.head;
         }
    else
    {
      oddlist.tail.setNext(new Node1(cur.getElement(),null));
  ...
  else
  {
   if(evenlist.head==null) {
       evenlist.head=new Node1(cur.getElement(),null);
    evenlist.tail=evenlist.head;
        }
    else   {
      evenlist.tail.setNext(new Node1(cur.getElement(),null));
